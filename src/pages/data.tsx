...
const newWeaponData = [
  ...
  },
  {
    ...
    "staggerModifier": "0%",
    "mod": "Cube Shield",
    "modDescription": "Cube Shield Generates a Cube Shield which absorbs up to 500 damage from incoming enemy projectiles. Lasts 15s. Reactivating fires the Cube Shield which damages enemies as is travels. Damage is increased if the Cube Shield has absorbed enemy projectile damage before firing.  Mod Power Requirement: 1,000",
    "hasMod": true
  },
  {
    "name": "Enigma",
    "type": "Hand Guns",
    "description": "Fires an electrical stream thatjumps to nearby targets within 7.5m, dealing 25% reduced damage perjump. Applies OVERLOADED for 5.2s. \n  ",
    "damage": "22",
    "rps": "4",
    "magazine": "30",
    "idealRange": "12m",
  ...
  },
  {
    ...
    "staggerModifier": "-15%",
    "mod": "Nano Swarm",
    "modDescription": "Unleash a swarm of Nanomachines that seek after enemies within 20 meters and repeatedly attack dealing 6 ACID damage per hit. Lasts 15 seconds. Mod Power Requirement: 750",
    "hasMod": true
  },
  {
    "name": "Rune Pistol",
    ...
    "staggerModifier": "0%",
    "mod": "Soul Brand",
    "modDescription": "Applies Soul Brand to all enemies within 25m which lasts 25s. Enemies killed while bearing the Soul Brand leave behind an Echo which lasts 10s before returning to the Nightmare Realm.Echoes are drawn to any survivor who walks within 3m, granting 20% of Max Health on contact. Mod Power Requirement: 850",
    "hasMod": true
  },
  {
    "name": "Sorrow",
    ...
    "staggerModifier": "5%",
    "mod": "Eulogy",
    "modDescription": "Recalls bolts which deal 30 damage when pulled fro, when striking targets on their return. Recalled bolts grant 2% of Max HP. Recalled bolts can also overfill Sorrow by up to +5. Any bolts will be returned to reserves. Mod Power Requirement: 600",
    "hasMod": true
  },
  {
    "name": "Star Shot",
    ...
    "staggerModifier": "10%",
    "mod": "Big Bang",
    "modDescription": "Funnels all current Mod Charges into the next shot. Projectile deals 65 direct damage and 65 Explosive damage in a 5m per Charge consumed. Explosion applies 75 BURNING damage over 10s per Charge consumed. Additional Charges consumed increase all damage by 5%. Max 5 Charges. Mod Power Requirement: 630",
    "hasMod": true
  },
  {
    "name": "AS-10 Bulldog",
  ...
  },
  {
    ...
    "staggerModifier": "-25%",
    "mod": "Supernova",
    "modDescription": "Fires the compressed remains of a dying star. On contact or hit wit the primary fire, causes Supernova to explode for 150 FIRE Damage, and 350 BURNING Damage over 10s to all targets within 4m.Striking the Supernova with Aphelion's primary fire increases its explosion radius by 25% and damage by 50%, and spawns a massive shockwave that deals 300 FIRE damage and also applies the initial BURNING amount.Mod Power Requirement: 1,250.",
    "hasMod": true
  },
  {
    "name": "XMG57 Bonesaw",
  ...
  },
  {
    ...
    "staggerModifier": "0%",
    "mod": "Beta Ray",
    "modDescription": "Brands a target for 30s. Branded enemies that die leave a Brand at their location.Reloading or Swapping detonates Brands dealing 225 damage.Additional Brands (3Max) on the same target deal 50% damage.Slain enemies return 5-15% of Ammo and Mod power to the weapon.Mod Power Requirement: 450",
    "hasMod": true
  },
  {
    "name": "Crescent Moon",
  ...
  },
  {
    ...
    "staggerModifier": "0%",
    "mod": "Bloodline",
    "modDescription": "Fires a devastating blast which penetrates through all enemies in its path. Deals 150 damage with a 25% Critical damage bonus, and 3x additional stagger. Bloodline damage increases by 50% for each enemy penetratedMod Power Requirement: 350",
    "hasMod": true
  },
  {
    "name": "Nightfall",
    ...
    "staggerModifier": "15%",
    "mod": "Dreadwalker",
    "modDescription": "Enter the Nightmare Realm. Nightfall gains infinite Ammo, a 35% Fire Rate increase, 10% Lifesteal, and becomes fully automatic. The wielder becomes significantly harder to hit while moving.Disables other weapons and Skills for the duration, or until Dreadwalker is deactivated. Lasts 10s.Mod Power Requirement: 1,250",
    "hasMod": true
  },
  {
    "name": "Plasma Cutter",
    ...
    "staggerModifier": "-20%",
    "mod": "Heat Sink",
    "modDescription": "Forces open Plasma Cutter's heat vents dispersing all heat. While active, Plasma Cutter generates 50% less heat, and ramping damage cap is increased to 3x Damage. Overheats automatically when deactivated. Lasts 20s.Mod Power Requirement: 850",
    "hasMod": true
  },
  {
    "name": "Sagittarius",
    ...
    "staggerModifier": "5%",
    "mod": "Starfall",
    "modDescription": "Fires a powerful arrow which deals 30 damage and opens a 7m portal that rains down star fragments. Each fragment deals 50 damage within 4m. Lasts 6s. Mod Power Requirement: 750",
    "hasMod": true
  },
  {
    ...
    "staggerModifier": "5%",
    "mod": "Guardian's Call",
    "modDescription": "When Mod Power is full, Primary Fire becomes Empowered and highlights enemies it strikes.Activation the Mod calls down a Guardian Sword on enemies struck by an Empowered Energy Disc. Swords deal 100 damage and 3x stagger within 5m. Mod Power Requirement: 750",
    "hasMod": true
  },
  {
    "name": "Atom Smasher",
  ...
  },
  {
    "name": "Gas Giant",
    "type": "Melee Weapons",
    "description": "Builds up charge with damage dealt. When full, basic attacks apply CORRODED, for 5s. Neutral Evade attacks explode in a 3m AOE and leave a TOXIC cloud. \n  ",
    "damage": "78",
    "criticalHitChance": "5%",
    "staggerModifier": "0%"
  },
  ...
  },
  {
    ...
    "staggerModifier": "-10%",
    "mod": "Krell Edge",
    "modDescription": "Charge to throw the Krell Axe which applies OVERLOADED on hit, dealing 50 SHOCK Damage every 5s for 10s. Shortly after throwing, another will appear in the wielders hand.Costs 25 Stamina.",
    "hasMod": true
  },
  {
    ...
    "staggerModifier": "-15%",
    "mod": "Bloodthirst",
    "modDescription": "Damage increases by +25% against BLEEDING enemies, and +25% when attacking from behind. Charge Attacks deal 200 BLEEDING damage over 10s.",
    "hasMod": true
  },
  {
    "name": "Atom Splitter",
    ...
    "staggerModifier": "6%",
    "mod": "Fission Strike",
    "modDescription": "On Neutral Evade Attacks Atom Splitter achieves Nuclear Fission, releasing a wave of charged particles which deals 150 Damage to targets within 20m.Charged Neutral Evade Attacks increase Range by 3x and Damage by 25%.",
    "hasMod": true
  },
  {
    "name": "Dreamcatcher",
    "type": "Melee Weapons",
    "description": " There is an ethereal lightness to this weapon, as though it were made of paper or breath.Though it strikes its foes forcibly enough.",
    "damage": "58",
    "criticalHitChance": "5%",
    "weakSpotDamage": "95%",
    "staggerModifier": "3%",
    "mod": "Dreamwave",
    "modDescription": "After dealing 250 damage, Charge Attack will release a Dreamwave, flowing outwards 20m and returning to caster.Dreamwave applies SLOW to all enemies for 10s and grants a Stack of REVERIE for each enemy affected. Each Stack grants +2% to All Damage and +2% Movement Speed, which lasts 15s.",
    "hasMod": true
  },
  {
    ...
    "staggerModifier": "-15%",
    "mod": "Death Sentence",
    "modDescription": "Dealing Melee Damage 6 times over 10s empowers Feral Judgement. When empowered, Neutral Backdash Charge attacks apply Death Sentence.After 15s of being sentenced, the enemy will suffer 10 Phantom Strikes, dealing 25 Damage each. Deals 25% additional damage to BLEEDING enemies.",
    "hasMod": true
  },
  {
    "name": "Godsplitter",
    ...
    "staggerModifier": "-20%",
    "mod": "Fracture",
    "modDescription": "Charge Attacks taint the blood of targets, causing all attacks from Godsplitter to register as Weakspot hits for 2s seconds.",
    "hasMod": true
  },
  {
    "name": "Hero's Sword",
    ...
    "staggerModifier": "-10%",
    "mod": "Energy Wave",
    "modDescription": "Charge attacks use 35 stamina to release an energy wave projectile allowing the wielder to strike enemies from much farther away.",
    "hasMod": true
  },
  {
    "name": "Nightshade",
    "type": "Melee Weapons",
    "description": "Fast striking claws with a high Critical Hit Chance.Neutral Dodge grants the power  of Lifesteal. \n  ",
    "damage": "47",
    "criticalHitChance": "18%",
    "weakSpootDamage": "+110%",
    "staggerModifier": "-20%",
    "mod": "Beyond The Veil",
    "modDescription": "Neutral Evade turns to mist, granting Nightshade 5% base damage as Lifesteal for 5s. Perfect Dodge doubles duration.",
    "hasMod": true
  },
  {
    "name": "Red Doe Staff",
    ...
    "staggerModifier": "8%",
    "mod": "Lifeline",
    "modDescription": "After dealing 250 damage, the next charge attack causes the spirit of the RED DOE to stampede forward, dealing 160 damage to enemies and regenerating 10% Health to allies in its path.",
    "hasMod": true
  },
  {
    "name": "Spectral Blade",
    ...
    "staggerModifier": "-25%",
    "mod": "Whirlwind",
    "modDescription": "Neutral Backdash Charge creates a Whirlwind of slashes which strike all enemies within 8m for 75 damage.",
    "hasMod": true
  },
  {
    "name": "Stonebreaker",
...
const newArmorData = [
  ...
  },
  {
    ...
    "type": "headpiece",
    "description": "This headpiece hails from the wild and mysterious world of Yaesha. Its smooth,featureless. design is both eerie and elegant, painted a stark white and adornedwith luxuriant fur and imposing horns. \n  ",
    "armor": "12",
    "weight": "6",
    "resistances": {
      "bleed": "0",
  ...
  {
    "name": "Dendroid Grips",
    "description": "Against all logic, these gloves feel natural. Like extensions of who you were meant to be. Seems like that should bother you more. \n  ",
    "armor": "4",
    "weight": "3",
    "resistances": {
      "bleed": "1",
  ...
  },
  {
    ...
    "description": "This isn't just any denim jacket, it's your denim jacket. It's not especial pdale. 7 ready, but it's comfortable, and in it you feel ready for anything. y, p If \n  ",
    "armor": "36",
    "weight": "18",
    "resistances": {
      "bleed": "3",
  ...
  },
  {
    ...
    "description": "Although apparently made of steel, they feel lighter than any boots you've eve worn. No... you feel lighter when wearing them. \n  ",
    "armor": "25",
    "weight": "13",
    "resistances": {
      "bleed": "2",
...
const newModData = [
  ...
  {
    "name": "Nano Swarm",
    "description": " Unleash a swarm of Nanomachines that seek after enemies within 20 meters and repeatedly attack dealing 6 ACID damage per hit. Lasts 15 seconds Mod Power Requirement: 750 "
  },
  {
    "name": "Soul Brand",
    "description": "Applies a Soul Brand to all enemies within 25m which lasts 25s. Enemies killed while bearing the Soul Brand leave behind an Echo which lasts 10s before returning to the Nightmare Realm. Echoes are drawn to any survivor who walks within 3m, granting 10% of Max Health on contact. Mod Power Requirement: 850"
  },
  {
    "name": "Eulogy",
    "description": "Recalls bots which deal 30 damage when pulled from a target and when striking targets on their return. Recalled bolts grant 2% of Max HP. Recalled bolts can also overfill Sorrow by up to +5. Any additional bolts will be returned to reserves. Mod Power Requirement: 600"
  },
  {
    "name": "Big Bang",
    "description": "Funnels all current Mod Charges into the next shot. Projectiles deal 65 direct damage and 65 Explosive damage in a 5m per Charge consumed. Explosion applies 75 BURNING damage over 10s per Charge consumed. Additional Charges consumed increase all damage by 5%. Max 5 Charges Mod Power Requirement:  630"
  },
  {
    "name": "Beta Ray",
    "description": "Brands a target for 30s. Branded enemies that die leave a Brand at their location.Reloading or Swapping detonates Brands dealing 225 damage.Addiotional Brands (3 Max) on the same target deal 50% damage.Salin enemies return 5-15% of Ammo and Mod power to the weapon.  Mod Power Requirement: 450"
  },
  {
    "name": "Supernova",
    "description": "Fires the compressed remains of a dying star. On contact or hit wit the primary fire, causes Supernova to explode for 150 FIRE Damage, and 350 BURNING Damage over 10s to all targets within 4m.Striking the Supernova with Aphelion's primary fire increases its explosion radius by 25% and damage by 50%, and spawns a massive shockwave that deals 300 FIRE damage and also applies the initial BURNING amount. Mod Power Requirement: 400"
  },
  {
    "name": "Moonlight Barrage",
    "description": "Empowers the Bow for 15s. Arrows apply Moonlight to enemies for 3s. Enemies struck by Crescent Moon while Moonlit release a Moon Essence which returns 1 arrow, heals 5% of Max Health, and grants 15% Fire and Reload Speed for 5s. Basic Shots automatically become Charged Shots. Manually Charged Shots fire two arrows.  Mod Power Requirement: 1,250"
  },
  {
    "name": "Ouroboros",
    "description": "Conjures 3 sword fragments that encircle the wielder for 30s. Performing a Melee Attacks lets loose a Fragment which taints the blood of targets, causing all attacks from Deceit to register as Weaspot hits for a short period of time. Charge Melee attack fires all remaining Fragments at once. Mod Power Requirement: 1,440"
  },
  {
    "name": "Bloodline",
    "description": "Fires a devastating blast which penetrates through all enemies in its path. Deals 120 damage with a 25% Critical damage bonus, and 2x additional stagger. Bloodline daage increases by 50% for each enemy penetrated. Mod Power Requirement: N/A"
  },
  {
    "name": "Dreadwalker",
    "description": "Enter the Nightmare Realm. Nightfall gains infinite Ammo, a 35% Fire Rate increase, 10% Lifesteal, and becomes fully automatic. The wielder becomes significatly harder to hit while moving. Disables other weapons and Skills for the duration, or until Dreadwalker is deactivated. Lasts 10s. Mod Power Requirement: 1,250"
  },
  {
    "name": "Heat Sink",
    "description": "Forces open Plasma Cutter's heat vents dispersing all heat. While active, Plasma Cutter generates 50% less heat, and ramping damage cap is increased to 3x Damage. Overheats automatically when deactivated. Lasts 20s. Mod Power Requirement: 850"
  },
  {
    "name": "Healing Shot",
    "description": "Launches a payload that explodes on contact with allies, healing 30% of their max health. When no ally is struck, payload lays dormant until an ally gets close. Dormant payload lasts 30s, slowly losing healing potency over time. Mod Power Requirement: 600"
  },
  {
    "name": "Starfall",
    "description": "Fires a powerful arrow which deals 30 damage and opens a 7m portal that rains down star fragments. Each fragment deals 50 damage within 4m. Lasts 6s. Mod Power Requirement: 750"
  },
  {
    "name": "Guardian's Call",
    "description": "Calls down a Guardian Sword on enemies struck by an Energy Disc. Swords deal 100 damage and 3x stagger within 5m. Mod Power Requirement: 750"
  },
  {
    "name": "Bloodthirst",
    "description": "Damage increases by +25% against BLEEDING enemies, and +25% when attacking from behind. Charge Attacks deal 100 BLEEDING damage over 10s Mod Power Requirement: N/A"
  },
  {
    "name": "Fission Strike",
    "description": "On Neutral Evade Attacks Atom Splitter achieves Nuclear Fission, releasing a wave of charged particles which deals 151.5 Damage to targets within 10m. Charged Neutral Evade Attacks increase range by 3x and Damage by 25% Mod Power Requirement: N/A"
  },
  {
    "name": "Dreamwave",
    "description": "After dealing 250 damage, Charge Attack will release a Dreamwave, flowing outwards 20m and returning to caster. Dreamwave applies SLOW to all enemies for 10s and grants a Stack of REVERIE for each enemy affected. Each Stack grants +2% to All Damage and +2% Movement Speed, which lasts 15s. Mod Power Requirement: N/A"
  },
  {
    "name": "Death Sentence",
    "description": "Dealing Melee Damage 6 times over 10s empowers Feral Judgement. When empowered, Neutral Backdash Charge Attacks apply Death Sentence. After 1.5s of being sentenced, the enemy will suffer 10 Phantom Strikes, dealing X25 Damage each. Deals 25% additional damage to BLEEDING enemies. Mod Power Requirement: N/A"
  },
  {
    "name": "Fracture",
    "description": "Charge Attacks taint the blood of targets, causing all attacks from Godsplitter to register as Weakspot hits for 3s seconds. Duration increases with additional fragments. Max 35s. Mod Power Requirement: N/A"
  },
  {
    "name": "Energy Wave",
    "description": "Charge attacks use 35 stamina to release an energy wave projectile allowing the wielder to strike enemies from much farther away. Mod Power Requirement: N/A"
  },
  {
    "name": "Athibar",
    "description": "Charge attacks use 25 stamina to throw the spear, which returns to the wielder's hand. Mod Power Requirement: N/A"
  },
  {
    "name": "Krell Edge",
    "description": "Charge to throw the Krell Axe which applies OVERLOAD on hit, dealing 50 SHOCK Damage every 5s for 10s. Shortly after throwing, another will appear in the wielders hand. Costs 25 Stamina Mod Power Requirement: N/A"
  },
  {
    "name": "Beyond The Veil",
    "description": "Neutral Evade turns to mist, granting Nightshade 5% base damage as Lifesteal for 5s. Perfect Dodge doubles duration. Mod Power Requirement: N/A"
  },
  {
    "name": "Lifeline",
    "description": "After dealing 250 damage, the next charge attack causes the spirit of the RED DOE to stampede forward, dealing 160 damage to enemies and regenerating 10% Health to allies in its path. Mod Power Requirement: N/A"
  },
  {
    "name": "Whirlwind",
    "description": "Neutral Backdash Charge creates a Whirlwind of slashes which strike all enemies within 8m for 75 damage. Mod Power Requirement: N/A"
  },
  {
    "name": "Faultline",
    "description": "Charge to fire off ground-based shockwaves which deal 115 damage. Costs 35 Stamina Mod Power Requirement: N/A"
  },
  {
    "name": "Astral Burst",
    "description": "Fires a short range burst of 7 star fragments which deal 35 damage each. Fragments bounce off walls up to 3 times, dealing 35% additional damage per bounce. Weakspot hits deal reduced damage. Mod Power Requirement: 450"
  },
  {
    "name": "Blood Draw",
    "description": "Shoots out razor-sharp Chain Shards which impale up to 5 targets within 15m, dealing 10 damage. On hit, chains are pulled towards the caster, dealing 250 damage split equally among enemies and applying 275 BLEEDING damage over 15s. Mod Power Requirement: 450"
  },
  {
    "name": "Bore",
  ...
  },
  {
    ...
    "description": "Fires a focused blast of air through all targets within 8m, dealing 155 damage and 5x impact. Mod Power Requirement: 500"
  },
  {
    "name": "Corrosive Rounds",
    "description": "Imbues ammunition with TOXIC and increases Range Crit Chance by 15% for 20s. Shots also apply CORRODED, dealing 100 damage over 10s. Mod Power Requirement: 1250"
  },
  {
    "name": "Defrag",
    "description": "Infects weapon with Malware for 30s, causing shots to apply FRAGMENTED for 5s. When a FRAGMENTED enemy dies, they create a Glitch that lasts 15s.Picking up a Glitch increases All damage by 20% for 15s. Destroying a Glitch causes it to destabilize, creating a 5m Virus Pool which deals 25 damage per second and applies the FRAGMENTED debuff to enemies inside. Virus Pools last 15s. Mod Power Requirement: 1500"
  },
  {
    "name": "Energy Wall",
    "description": "Deploys an energy barrier on impact with ground. Allies can shoot through Energy Wall but enemy projectiles are absorbed (up to 500 damage received). Max 1 Wall at a time. Lasts 30s. Mod Power Requirement: 500"
  },
  {
    "name": "Familiar",
    "description": "Summons Faerie Familiar to aid in combat. The Familiar selects a random enemy within 10m and slashes through them for 25 damage each attack. Familiar will select a new target when the previous one dies. Lasts 15s. Mod Power Requirement: 1,000"
  },
  {
    "name": "Fargazer",
    "description": "Calls forth an eye of Legion to gaze at player's AIM target. For every 0.25s Fargazer focuses on a target within 25m, a stack of MADNESS Status is applied for 5s. Each stack deals 3 Damage per second. Max 10 stacks. Lasts 30s. Mod Power Requirement: 1,250"
  },
  {
    "name": "Firestorm",
    "description": "Creates a whirling cyclone that sucks in nearby targets and applies BURNING for 10s. The center of the cyclone deals 75 FIRE damage per second. Lasts 15s. Mod Power Requirement: 1,250"
  },
  {
    "name": "Healing Shot",
    "description": "Launches a payload that explodes on contact with allies, healing 30% of their max health. When no ally is struck, payload lays dormant until an ally gets close. Dormant payload lasts 30s, slowly losing healing potency over time. Mod Power Requirement: 600"
  ...
  {
    "name": "Helix",
    "description": "Shoots a helix of missiles, dealing 120 damage. On contact, divides into 6 smaller rockets which seek additional targets, dealing 30 damage on contact. Mod Power Requirement: 850"
  },
  {
    "name": "Hot Shot",
    "description": "Imbues ammunition with FIRE and increases Ranged damage by 15% for 20s. Shots also apply BURNING, dealing 200 FIRE Damage over 10 seconds. Mod Power Requirement: 1250"
  },
  {
    "name": "Overflow",
    "description": "Imbues ammunition with SHOCK and increases Fire Rate by 15% and Reload Speed by 15% for 20 seconds. Shots also apply OVERLOADED, dealing 35 SHOCK Damage every 5s for 15s. Mod Power Requirement: 1,250"
  },
  {
    "name": "Prismatic Driver",
    "description": "Fires a superheated beam which deals 25 Mod Damage per second. Sustaining the beam on a target causes an explosion which deals 150 Mod damage in a 3m AOE. Mod Power Requirement: 50 per Pulse."
  },
  {
    "name": "Root Blades",
    "description": "Fires a volley of Root Blades in an arc which each deal 25 Damage and apply 200 BLEEDING damage over 10s Mod Power Requirement: 750"
  },
  {
    "name": "Rootlash",
    "description": "Launches a projectile which summons a Root Tentacle. Tentacles deal 30 damage and steal 1.5% of the hero's Max Health per hit. Lasts 20s. (Max 2) Mod Power Requirement: 450"
  },
  {
    "name": "Rotted Arrow",
    "description": "Fires a rotten arrow that deals 20 damage and detonates for another 60 damage within 4m. A deadly gas cloud is left behind that deals 200 damage over 5s. Mod Power Requirement: 400"
  },
  {
    "name": "Scrap Shot",
    "description": "Fires a caltrops grenade that explodes to cover an area of 6m. Caltrops deal 20 damage per second and SLOW to enemies that walk over them. Lasts 10s. Mod Power Requirement: 750"
  },
  {
    "name": "Skewer",
    "description": "Fires a Wretched Spear which embeds itself on contact. Spears deal 125 damage on hit, rapidly dividing inside the target until bursting, dealing 140 damage to all targets within 3m. Spears embedded in the environment remain in place for 10s. Mod Power Requirement: 850"
  },
  {
    "name": "Song of Eafir",
    "description": "Fires a shot infused with the binding power of the Song of Eafir. Staggers most ground enemies within 10m and deals 150 damage to Flying enemies within the same range.The song continues for 15s, afflicting targets within 15m with SLOW, and a 15% decrease to damage dealt. Mod Power Requirement: 1000"
  },
  {
    "name": "Soulbinder",
    "description": "Fires a projectile that attaches to the enemy dealing 40 damage. Enemies within 7m become bound to the primary target after impact and share 60% of damage dealt to them. Lasts 15s. Mod Power Requirement: 650"
  },
  {
    "name": "Space Crabs",
    "description": "Launch an alien egg that bursts on impact, releasing 5 Space Crabs. Crabs follow the caster, leaping towards enemies within 4m, and exploding, dealing 60 Damage each. Mod Power Requirement: 450"
  },
  {
    "name": "Stasis Beam",
    "description": "Fires a beam which deals 15 damage per second, and applies SLOW Debuff. After 3s of application to a target, SLOW becomes STASIS, freezing the target in place for 10s. Mod Power Requirement: 50 per Pulse."
  },
  {
    "name": "Time Lapse",
    "description": "Creates a 6m blast which freezes all standard enemies for 7s. Dealing damage to frozen enemies immediately breaks the Time Lapse effect, applying SLOW for the remaining duration. Mod Power Requirement: 1,000"
  },
  {
    "name": "Tremor",
    "description": "Fires a projectile that cracks the ground and spawns shockwaves that deal 75 damage Within 9m for 6s. Shockwaves inflict 3x impact. Mod Power Requirement: 900"
  },
  {
    "name": "Voltaic Rondure",
    "description": "Launches a slow-moving orb that pulses every 0.5s, striking enemies within 3m for 20 SHOCK damage and applying OVERLOADED for 15s. The orb lasts 20s. The orb can be overcharged by striking it with additional damage. Mod Power Requirement: 850"
  },
  {
    "name": "Witchfire",
    "description": "Fires a highly volatile projectile that explodes to leave a line of flaming terrain. Deals 55 FIRE Damage per second, and applies BURNING, dealing 200 damage over 10s. Lasts 5s. Mod Power Requirement: 750"
  },
  {
    "name": "Accelerator",
    "description": "Charge Melee Attacks increase the speed of all Melee Attacks by 10% for 5s. Mod Power Requirement: N/A"
  }
]
